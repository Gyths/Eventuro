...
export default function EventCard({
  ...
  const month = s.toLocaleString("es", { month: "short", timeZone: "UTC" }).toUpperCase();
  ...
  return (
    <article onClick={onClick} className={`cursor-pointer rounded-2xl bg-white shadow-md hover:shadow-lg flex flex-col justify-between h-[22rem] ${className}`}>
      <div className="p-3">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="mt-1 flex items-start gap-1.5 text-[13px] text-gray-600">
          <svg className="mt-[2px] h-4 w-4 text-red-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="mt-4 flex items-start justify-between">
          ...
          <div className="text-right leading-none text-gray-900">
            <div className="flex items-baseline justify-end">
              ...
              <span className="ml-[2px] text-[10px] font-semibold relative -top-1">{mm}</span>
            </div>
            <div className="mt-[2px] text-[11px] tracking-wide text-gray-500">horas</div>
          </div>
        </div>
      </div>
    </article>
