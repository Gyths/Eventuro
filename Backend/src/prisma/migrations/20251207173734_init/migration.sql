...
-- CreateEnum
CREATE TYPE "public"."STATUS_USER" AS ENUM ('A', 'S', 'B', 'D');
...
-- CreateEnum
CREATE TYPE "public"."EVENT_STATUS" AS ENUM ('P', 'A', 'D', 'C');
...
-- CreateEnum
CREATE TYPE "public"."REFUND_STATUS" AS ENUM ('NONE', 'REQUESTED', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "public"."DISCOUNT_TYPE" AS ENUM ('CASH', 'PERCENTAGE');

-- CreateEnum
CREATE TYPE "public"."DISCOUNT_SCOPE" AS ENUM ('GLOBAL', 'EVENT', 'USER', 'EVENT_USER');

-- CreateEnum
CREATE TYPE "public"."STATUS_DISCOUNT" AS ENUM ('A', 'I');

-- CreateEnum
CREATE TYPE "public"."ORGANIZER_STATUS" AS ENUM ('DRAFT', 'SUBMITTED', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "public"."STAGED_SALE_PERIOD" AS ENUM ('D', 'W', 'M');

-- CreateEnum
CREATE TYPE "public"."COMPLAINT_STATE" AS ENUM ('PENDING', 'ACCEPTED', 'NEGATED');

-- CreateEnum
CREATE TYPE "public"."COMPLAINT_TARGET" AS ENUM ('PAGE', 'ORGANIZER', 'EVENT', 'OTHERS');

-- CreateEnum
CREATE TYPE "public"."COMPLAINT_TYPE" AS ENUM ('CLAIM', 'COMPLAINT');
...
CREATE TABLE "public"."Administrator" (
    "administratorId" BIGSERIAL NOT NULL,
    "userId" BIGINT NOT NULL,
...
CREATE TABLE "public"."Organizer" (
    ...
    "status" "public"."ORGANIZER_STATUS" NOT NULL DEFAULT 'DRAFT',
...
CREATE TABLE "public"."Event" (
    ...
    "feeId" BIGINT,
    "title" TEXT NOT NULL,
    "imagePrincipalKey" TEXT NOT NULL,
    "imageBannerKey" TEXT NOT NULL,
    "refundPolicyFileKey" TEXT,
    ...
    "ticketLimitPerUser" INTEGER DEFAULT 10,
    "active" BOOLEAN NOT NULL DEFAULT true,
    "stagedSale" BOOLEAN NOT NULL DEFAULT false,
    "quantityStagedSale" BIGINT,
    "stagedSalePeriod" "public"."STAGED_SALE_PERIOD",
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."EventDateZone" (
    ...
    "quantityTicketsReleased" BIGINT NOT NULL,
    "active" BOOLEAN NOT NULL DEFAULT true,
    "lastCapacityRemainingIncrement" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."EventSalesPhase" (
    ...
    "quantityTicketsSold" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."Ticket" (
    ...
    "active" BOOLEAN NOT NULL DEFAULT true,
    "refundStatus" "public"."REFUND_STATUS" NOT NULL DEFAULT 'NONE',
...
CREATE TABLE "public"."Discount" (
    ...
    "startAt" TIMESTAMP(3) NOT NULL,
    "endAt" TIMESTAMP(3) NOT NULL,
    "status" "public"."STATUS_DISCOUNT" NOT NULL DEFAULT 'A',
...
-- CreateTable
CREATE TABLE "app"."AuditTransaction" (
    "auditTransactionId" BIGSERIAL NOT NULL,
    "targetTableName" TEXT NOT NULL,
    "operationType" TEXT NOT NULL,
    "primaryKeyJson" JSONB,
    "actorUserId" BIGINT,
    "actorIpAddress" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "AuditTransaction_pkey" PRIMARY KEY ("auditTransactionId")
);

-- CreateTable
CREATE TABLE "app"."AuditChange" (
    "auditChangeId" BIGSERIAL NOT NULL,
    "auditTransactionId" BIGINT NOT NULL,
    "columnName" TEXT NOT NULL,
    "oldValueJson" JSONB,
    "newValueJson" JSONB,
    "isChanged" BOOLEAN,

    CONSTRAINT "AuditChange_pkey" PRIMARY KEY ("auditChangeId")
);
...
CREATE TABLE "public"."Complaint" (
    ...
    "evidenceUrlKeys" TEXT NOT NULL,
    "dateCreation" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "target" "public"."COMPLAINT_TARGET" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Administrator_userId_key" ON "public"."Administrator"("userId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Fee_percentage_key" ON "public"."Fee"("percentage");
...
-- CreateIndex
CREATE INDEX "Discount_eventId_idx" ON "public"."Discount"("eventId");

-- CreateIndex
CREATE INDEX "Discount_userId_idx" ON "public"."Discount"("userId");

-- CreateIndex
CREATE INDEX "Discount_startAt_endAt_idx" ON "public"."Discount"("startAt", "endAt");

-- CreateIndex
CREATE UNIQUE INDEX "Discount_code_scope_eventId_userId_key" ON "public"."Discount"("code", "scope", "eventId", "userId");
...
-- AddForeignKey
ALTER TABLE "public"."Administrator" ADD CONSTRAINT "Administrator_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("userId") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Discount" ADD CONSTRAINT "Discount_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "public"."Event"("eventId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Discount" ADD CONSTRAINT "Discount_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("userId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "app"."AuditChange" ADD CONSTRAINT "AuditChange_auditTransactionId_fkey" FOREIGN KEY ("auditTransactionId") REFERENCES "app"."AuditTransaction"("auditTransactionId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Complaint" ADD CONSTRAINT "Complaint_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
