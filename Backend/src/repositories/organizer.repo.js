...
export function findOrganizerByUserIdRepo(userId) {
...
export function findOrganizerByIdNumberNotUserRepo(idNumber, userId) {
...
export function upsertOrganizerRepo({ userId, idType, idNumber, companyName, status }) {
