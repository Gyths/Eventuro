            ...
            for (const zone of input.zones) {
                ...
                if (Array.isArray(zone.allocations) && zone.allocations.length > 0) {
                    ...
                    for (const allocation of zone.allocations) {
                        const eventDateZoneAllocation = await tx.eventDateZoneAllocation.create({
                            data: {
                                eventDateZoneId,
                        ...
                        allocationsCreated.push({
                            eventDateZoneAllocationId: Number(eventDateZoneAllocation.eventDateZoneAllocationId),
                        });
                    }
                }
                ...
                zonesCreated.push({
                    ...
                    eventDateZoneAllocation: allocationsCreated ? allocationsCreated : null
                });
            }
